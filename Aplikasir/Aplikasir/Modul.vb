...
Module Modul
    ...
    Public kosong As String = "Data tak boleh kosong"

    Sub koneksi()

        conn = New SqlConnection("Data Source = DESKTOP-E1JB7KO\SQLEXPRESS;Initial Catalog=dbKasir;Integrated Security=True")
        'conn = New SqlConnection("Data Source=DESKTOP-C6F2DKO\SQLEXPRESS01;Initial Catalog=dbKasir;Integrated Security=True")
